...
package com.season.designsystem.icon
...
object NiaIcons {
    ...
    val NoImages = Icons.Rounded.NoPhotography
    val Scan = Icons.Outlined.DocumentScanner
    val Lens = Icons.Filled.Lens
    val Document = Icons.Rounded.FilePresent
    val Delete = Icons.Outlined.Delete
    val Crop = Icons.Rounded.Crop
    val Edit = Icons.Outlined.Edit
    val Save = Icons.Rounded.SaveAs
    val Menu = Icons.Rounded.MoreVert
    val MarginOn = Icons.Rounded.Margin
    val MarginOff = Icons.Outlined.Margin
    val Checked = Icons.Rounded.CheckCircle
    val Share = Icons.Rounded.Share
    val Home = Icons.Rounded.Home
    val Error = Icons.Rounded.SentimentDissatisfied
}
